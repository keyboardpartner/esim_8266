...
The XILINX Webpack ISE project *MojoFPGA_Picoblaze.xise* contains a Picoblaze CPU core which lets the onboard-LEDs blink. This might be used for the GODIL as well (needs some project changes).
